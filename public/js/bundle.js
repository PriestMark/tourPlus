...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFwbWFya21pY2hhZWwiLCJhIjoiY2t6eXBsc2ZiMDJuODNkbzR3aDEwOGNqMyJ9.6xc9xpgXGPgsoCF3qhJOyQ';
...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<dif class=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'logged in sucessfuly');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Errpr logging out! Try Again');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type, " data was updated"));
            }
